...
;0456:
bakstk:
    db 0x21,0x04,0x00,0x39,0x7e,0x23,0xfe,0x81,0xc0,0x4e
...
crestr:
    pop de
    db 0xcd,0xac,0x13   ;call baktmp
    ex de,hl
    db 0xcd,0xe5,0x11   ;call savstr
mvstpt:
    db 0xcd,0xac,0x13   ;call baktmp
    pop hl
...
if:
    ...
    db 0xcd,0x0d,0x12
    db 0xeb,0x21,0xcb,0x0c,0xe3,0xd5,0xc3,0xce,0x0a
    call getchr
    db 0xcd,0x5b,0x18
    ex (sp),hl
    db 0xcd,0xac,0x17
    ...
    db 0xcd,0xac,0x17
    pop hl
    db 0xcd,0xa3,0x17   ;call loadfp
    push hl
    db 0xcd,0xcf,0x17
    db 0xe1,0xc1,0x90
    db 0xcd,0xa3,0x17   ;call loadfp
    db 0xca,0x62,0x0d,0xeb,0x22,0x6c,0x20,0x69,0x60,0xc3
    db 0xc1,0x08,0xf9,0x2a,0xde,0x20,0x7e,0xfe,0x2c,0xc2,0xc5,0x08
    call getchr
    db 0xcd,0x2a,0x0d
;0d72:
getnum:
...
oprnd:
    ...
    db 0xa7,0xca,0x6e,0x11,0xd6,0xb6,0xd2,0x73,0x0e,0xcd,0x80,0x0d
    call chksyn
    db 0x29
    db 0xc9,0x16,0x7d
    call eval1
...
frmevl:
    ...
    db 0x17,0xe1,0xc9,0x06,0x00,0x07,0x4f,0xc5
    call getchr
...
sgnexp:
    ...
    cp 0xad
    db 0xc8,0xfe
    db 0x2d,0xc8,0x14,0xfe,0x2b,0xc8,0xfe,0xac,0xc8,0x2b,0xc9
por:
    db 0xf6
pand:
    xor a
...
arldsv:
    ...
    db 0xda,0x07,0x11,0x47,0x4f,0x7e,0x23,0x16,0xe1,0x5e,0x23,0x56,0x23,0xe3,0xf5
    call cpdehl
    db 0xd2,0x80,0x10,0xe5
    db 0xcd,0x40,0x18
    db 0xd1,0x19,0xf1,0x3d,0x44,0x4d,0xc2
    ...
    db 0xe1,0x22,0xee,0x20,0xe1,0xc9
idtest:
    push hl
...
grbdon:
    ...
    db 0xcd
    db 0xf6,0x12
    db 0xc3,0xb0,0x12,0xc1,0xeb,0x2a,0xea,0x20,0xeb
    call cpdehl
    db 0xca,0x1c
    db 0x13
    db 0xcd,0xa3,0x17
...
tostra:
    db 0x2c
tsalp:
    db 0x2d,0xc8,0x0a,0x12,0x03,0x13,0xc3,0x82,0x13
getstr:
    call tststr
gstrcu:
    db 0x2a,0xf4
    db 0x20,0xeb,0xcd,0xac,0x13,0xeb,0xc0,0xd5,0x50,0x59,0x1b,0x4e,0x2a,0xd3,0x20
    call cpdehl
    db 0xc2,0xaa,0x13,0x47,0x09,0x22,0xd3,0x20,0xe1,0xc9,0x2a,0xc1,0x20,0x2b
    db 0x46,0x2b,0x4e,0x2b,0x2b,0xcd,0x75,0x07,0xc0,0x22,0xc1,0x20,0xc9,0x01,0x3c,0x11
    db 0xc5
    db 0xcd,0x8b,0x13
    db 0xaf,0x57,0x32,0xbd,0x20,0x7e,0xb7,0xc9,0x01,0x3c,0x11,0xc5
    db 0xcd,0xc1,0x13
...
noswap:
    ...
    ret nc
    push af
    db 0xcd,0xba,0x17   ;call signs
    db 0x67
    db 0xf1
    db 0xcd,0xd3,0x15   ;call scale
    db 0xb4,0x21,0xf4,0x20,0xf2,0x4e,0x15
    db 0xcd,0xb3,0x15   ;call plucde
    db 0xd2,0x94
    db 0x15,0x23,0x34,0xca,0xbc,0x04,0x2e,0x01
    db 0xcd,0xe9,0x15   ;call shrt1
    db 0xc3,0x94,0x15
mincde:
    xor a
    sub b
    ld b,a
    db 0x7e,0x9b,0x5f,0x23,0x7e,0x9a,0x57,0x23,0x7e,0x99,0x4f,0xdc,0xbf,0x15,0x68
    db 0x63,0xaf,0x47,0x79,0xb7,0xc2,0x81,0x15,0x4a,0x54,0x65,0x6f,0x78,0xd6,0x08,0xfe
    db 0xe0,0xc2,0x62,0x15
;1574
reszer:
    db 0xaf,0x32,0xf7,0x20,0xc9,0x05,0x29,0x7a,0x17,0x57,0x79,0x8f
...
nomadd:
    ...
    rra
    ld d,a
    db 0x7b,0x1f,0x5f,0x78,0x1f,0x47
...
dvbcde:
    ...
    db 0x37,0xd2
resdiv:
    db 0xc1,0xe1,0x79,0x3c,0x3d,0x1f,0xfa,0x95,0x15,0x17,0x7b,0x17,0x5f,0x7a
...
dpoint:
    inc c
    db 0xca,0x6f,0x18,0xe5,0x7b,0x90,0xf4,0xb0,0x18,0xf2,0xa6,0x18
    db 0xf5
    db 0xcd,0x9c,0x16
...
width:
    ...
    db 0xcd,0x72,0x0d
    call deint
    db 0xe3,0x73,0x23,0x72,0xe1,0xc9
    call tstnum
    db 0xcd,0xb7,0x09

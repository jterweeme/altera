...
db 0xcd,0xc5,0x05
db 0x23
db 0xeb,0x62,0x6b,0x7e,0x23,0xb6,0xca,0x05,0x05,0x23,0x23,0x23
db 0xaf,0xbe,0x23,0xc2
...
db 0x66,0x6f,0x3f,0xc8,0x3f,0xd0,0xc3,0x9c,0x05,0xc0,0x2a,0x6e,0x20
db 0xaf,0x77,0x23
...
;lbl_0609:
crunch:
db 0xaf,0x32,0xbe,0x20,0x0e,0x05,0x11
...
clotst:
    ...
    and 0x7f
    db 0xfe,0x0f,0xc0,0x3a,0x55,0x20,0x2f,0x32,0x55,0x20
    xor a
    ret
;lbl_07c1:
list:
    ...
    ret nz
    pop bc
    db 0xcd,0x99,0x05   ;call srchln
    push bc
    db 0xcd,0x17,0x08   ;call setlin
listlp:
    pop hl
    ld c,(hl)
    inc hl
...
;lstlp3:
    ...
    inc de
    or a
    db 0xf2,0xff,0x07,0x0d,0xc2,0xff,0x07,0xe6,0x7f
    call outc
    db 0x1a,0x13
...
tstbrk:
    rst 0x18
    ret z
db 0xd7,0xfe,0x1b,0x28,0x11,0xfe,0x03,0x28,0x0d,0xfe,0x13,0xc0,0xd7,0xfe
...
let:
    ...
    db 0xca,0x1c,0x0b
    call chksyn
    db 0x88,0x2b,0x4b,0x0d,0x78,0xca
    db 0xed,0x08
    call getln
    db 0xfe,0x2c,0xc0,0xc3,0x1d,0x0b
    db 0xcd,0x84,0x0d
    db 0x7e,0xfe
...
db 0x0d,0x2b
    ...
    db 0xcd,0x09,0x12
    db 0xcd,0x8e,0x13
    db 0x01,0xe9,0x13,0xc5,0x7e,0x23,0x23,0xe5
    db 0xcd,0x64,0x12
...
db 0x22,0xcc,0x05,0x09,0xe3,0x23,0xeb,0x79
db 0xcd,0xfd,0x11
...
db 0x2c
    call getint
db 0xc1,0xcd,0x4e,0x20,0xab,0xa0,0xca,0xb7,0x14,0xc9
db 0xcd,0xd3,0x14
...
db 0xe1
db 0xcd,0xa3,0x17,0xe5
db 0xcd,0x0e,0x15,0xe1,0xc3,0xb4,0x1a
db 0xcd,0x54,0x17
db 0x21
